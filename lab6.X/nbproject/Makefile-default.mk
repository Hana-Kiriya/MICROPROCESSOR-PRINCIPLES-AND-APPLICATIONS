...
${OBJECTDIR}/test.o: test.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/test.o 
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/test.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -d__DEBUG  -q -p$(MP_PROCESSOR_OPTION)  -l\"${OBJECTDIR}/test.lst\" -e\"${OBJECTDIR}/test.err\" $(ASM_OPTIONS)    -o\"${OBJECTDIR}/test.o\" \"test.asm\" 

...
void __attribute__((picinterrupt(("")))) ISR(){
    if(INTCONbits.INT0IF){
        inc = 1;
        if(start == 0) _delay((unsigned long)((250)*(125000/4000.0)));
        start = 1;
        INTCONbits.INT0IF = 0;
    }
}
void main(void)
{
    ...
    while(1){
        if(start){
            if(CCPR1L == 0x13 && CCP1CONbits.DC1B == 0b00){
                inc = 0;
                dec = 1;
                _delay((unsigned long)((30)*(125000/4000.0)));
                CCP1CONbits.DC1B = 0b11;
                CCPR1L--;
                _delay((unsigned long)((30)*(125000/4000.0)));
            }
            else if(CCPR1L == 0x03 && CCP1CONbits.DC1B == 0b11){
                inc = 1;
                dec = 0;
                _delay((unsigned long)((30)*(125000/4000.0)));
